...
//Set I2C Freq, in kHz
//MLX90641_I2CFreqSet(1000) sets frequency to 1MHz
...
int MLX90641_I2CWrite(uint8_t _deviceAddress, unsigned int writeAddress, uint16_t data) {
    ...
    uint16_t dataCheck;
    MLX90641_I2CRead(_deviceAddress, writeAddress, 1, &dataCheck);
    if (dataCheck != data) {
